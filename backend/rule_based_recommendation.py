    ...
    DESTINATIONS = {
        ...
        "premium": {
            "beach": [
                ...
                {"name": "Lakshadweep", "famous_for": "Azure lagoons and coral islands", "image_url": "https://images.unsplash.com/photo-1616391182219-e080b4d10338?auto=format&fit=crop&q=80&w=800&ixlib=rb-4.0.3"}
            ],
            "mountains": [
                ...
                {"name": "Gulmarg", "famous_for": "Skiing and world's highest gondola", "image_url": "https://images.unsplash.com/photo-1629705910408-72547b74f4b2?auto=format&fit=crop&q=80&w=800&ixlib=rb-4.0.3"}
            ],
            "adventure": [
